      ...
      <Row>
        ...
        <Form ref="formData" :model="formData" :rules="ruleValidate">
          ...
          <Row :gutter="32">
            ...
            <Col span="6">
              <FormItem label="PUBLIC网段" label-position="top" prop="public_subnet">
            ...
            <Col span="6">
              <FormItem label="PRIVATE网段" label-position="top" prop="private_subnet">
          ...
          <Row :gutter="32">
            <Col span="4">
              <FormItem label="节点编号" label-position="top" prop="node1_id">
                <InputNumber v-model="formData.node1_id" disabled placeholder="1,2..">
                </InputNumber>
              </FormItem>
            </Col>
            <Col span="4">
          ...
          <Row :gutter="32">
            <Col span="4">
              <FormItem label="节点编号" label-position="top" prop="node2_id">
                <InputNumber v-model="formData.node2_id" disabled placeholder="1,2..">
                </InputNumber>
              </FormItem>
            </Col>
            <Col span="4">
          ...
          <FormItem>
            ...
            <Tooltip placement="top">
              <Button type="error" style="margin-right: 16px" disabled @click="handleSubmit('formData')">
                慎用：RAC安装清理
              </Button>
              <div slot="content">
                <p>
